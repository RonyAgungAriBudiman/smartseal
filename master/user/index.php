...
{	 
  ...
  {  
    $sql ="INSERT INTO ms_user (UserID, Password, Nama, Email, Admin, AreaID) VALUES ('".$_POST['userid']."', '".$_POST['password']."', '".$_POST['nama']."', '".$_POST['email']."' , '".$_POST['admin']."' , '".$_POST['areaid']."')";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <tbody>
                 <?php 
					$sql ="SELECT a.*, b.Area FROM ms_user a 
						...
						<div class="modal fade" id="exampleModaledit<?php echo $row['UserID']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <?php
							  $sql="SELECT a.* FROM ms_user a
							  		LEFT JOIN ms_area b on b.AreaID = a.AreaID WHERE a.UserID ='".$row['UserID']."'" ;
							  $data= $sqlLib->select($sql);
							  ?>
								  ...
								  <div class="form-group">
					                ...
					                <label for="Description">Area</label>
					                 <select class="form-control" id="areaid" name="areaid">
					                  ...
					                  <option value="<?php echo $data[0]['AreaID']; ?>"><?php echo $data[0]['Area']; ?></option>  
					                  <?php
