...
//echo $tanggal.'-'.$kerusakanid.'-'.$analisa.'-'.$perbaikan.'-'.$kategori;
?>
...
<form method="post" id="form-transaksi"  name="form"  action="index.php?m=perbaikan&sm=petugas" > 
            ...
            <div class="box-body">
                ...
                <div form-group">
                    ...
                    <label for="produkid">&nbsp;</label>
                        <a href="index.php?m=perbaikan&tgl=<?php echo $tanggal?>&kerusakanid=<?php echo $kerusakanid?>&analisa=<?php echo $analisa?>&perbaikan=<?php echo $perbaikan?>&kategori=<?php echo $kategori?>&klasifikasi=<?php echo $klasifikasi?>"><input type="button" class="form-control btn-danger" name="back" id="next" value="Back" ></a>
